...
```
- SecForProcessTime : 초당 처리 가능한 연산 수(추정)
## 요약
- 초기 생성 속도 : OOP가 더 빠름(약 10~15배)
- 런타임 처리 성능 : ECS가 더 빠름(약 3~8 배)
- 메모리 할당 : ECS 초기비용 높지만 실행 중 GC 발생 없음
